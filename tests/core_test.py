...
from graphax.examples import (Simple, Helmholtz, Perceptron, f, g, Encoder, 
                              RoeFlux_1d, RoeFlux_3d, RobotArm_6DOF)
...
class GraphaxAlignmentTest(unittest.TestCase):
    ...
    #     jaxpr = jax.make_jaxpr(attn_fn)(*xs)
    #     print(jaxpr)
    ...
    #     jaxpr = jax.make_jaxpr(encoder_block)(*xs)
    #     print(jaxpr)
